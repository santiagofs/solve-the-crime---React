  ...
  return <div>
    <div className='flex h-[calc(100vh-50px)]'>
      ...
      <dialog className="p-10 border-solid border-red-500 border-2 rounded-md text-center font-bold shadow-md" open={gameStatus === 'loose'}>
        ...
        <div><TextButton action={() => {}}>Go To Map</TextButton> <TextButton className='bg-amber-600 text-white font-bold' action={() => dispatch(gameActions.createLevel(currentLevel))}>Restart</TextButton></div>
      </dialog>
      ...
      <dialog className="p-10 border-solid border-amber-500 border-2 rounded-md text-center font-bold shadow-md" open={gameStatus === 'win'}>
        ...
        <div><TextButton action={() => {}}>Go To Map</TextButton> <TextButton className='bg-amber-600 text-white font-bold' action={() => dispatch(gameActions.createLevel(nextLevel))}>Next Level</TextButton></div>
      </dialog>
    </div>
